 ...
 * account is deleted and the unique constraint can be created safely — without
 * needing `--accept-data-loss`, which would blanket-accept ANY destructive
 * schema change, not just this one, harmless-looking field.
 */
async function main() {
  try {
